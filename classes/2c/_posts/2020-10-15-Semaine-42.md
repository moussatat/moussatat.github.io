...
### Choix de spécialités 1ère au vu d'une Licence
...
### Choix de spécialités au vu d'une classe préparatoire 
...
### Choix de spécialités 1ère au vu d'un B.U.T. (ex-DUT)
...
### Choix de spécialités 1ère au vu d'un B.T.S.
