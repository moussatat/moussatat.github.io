...
- 02/25 liens [BoOST](https://boost.u-bordeaux.fr/home) pour l'orientation des filières scientifiques de l'université de Bordeaux
...
{: .box-note} 
## Le Bac 2021 Les épreuves, dates et coefficients

Pour la filière générale  

<img src="https://i.imgur.com/Jmm1qbG.jpg"/>

Pour les filières technologiques
...
Le site [BoOST](https://boost.u-bordeaux.fr/home) de l'université de Bordeaux permet de voir la correspondance entre les mentions de licence en sciences et technologies et les choix de spécialités.

{: .box-warning}
### Recommandations de spécialités au vu d'une CPGE 
...
{: .box-warning}
### Recommandations de spécialités 1ère au vu d'un B.U.T.
...
{: .box-note}
## Webographie de quelques formations post-bac 
