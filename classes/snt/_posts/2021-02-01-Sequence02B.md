...
1. À l'aide de la page [wikipedia](https://fr.wikipedia.org/wiki/M%C3%A9tadonn%C3%A9e), donner la définition d'une métadonnée et citer un exemple. 
1. Saurez-vous retrouver l'endroit ou a été prise la photo ci-dessous ?

[*Indication*](http://exif.regex.info/exif.cgi)
