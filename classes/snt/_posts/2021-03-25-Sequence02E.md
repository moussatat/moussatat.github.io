...
title: "Séquence 2 - Le Web : Les cookies"
subtitle: "RGPD et la CNIL"
date: 2021-03-25
tags: [snt] 
comments: false
social-share: false
--- 
{: .box-error}  
## Support [**<i class="far fa-file-pdf"></i>**](https://drive.google.com/file/d/1l0dGheaba38-cxS44wfuy9z9ukqriuR1/view)
	 
{: .box-note}
## Introduction
<div>
{%- include extensions/vimeo.html id='138623890' -%}
</div>  
...
{: .box-warning}
## Exercice 2 Visualisation de cookies
...
1. Visiter le site [www.lemonde.fr](https://www.lemonde.fr/) depuis l'application ```CookieViz```. Accepter les cookies. Patienter une minute en naviguant sur différentes pages du sites. Vous devez observer un graphe similaire au graphe ci-contre<label for="One" class="margin-toggle sidenote-number"></label><input type="checkbox" id="One" class="margin-toggle"/>
	<span class="sidenote" align="left" markdown="1">**Les liens rouges indiquent une transmission d'information par les cookies à des sites tiers**. ![le monde](https://i.imgur.com/MEMRgmb.png)</span>.  
1. Faire de même avec [www.fnac.com](https://www.fnac.com/). N'oubliez pas d'accepter les cookies. Le graphe doit se peupler de sites supplémentaires<label for="One" class="margin-toggle sidenote-number"></label><input type="checkbox" id="One" class="margin-toggle"/>
	<span class="sidenote" align="left" markdown="1">Cookies utilisés par fnac et lemonde  ![fnac et lemonde](https://i.imgur.com/sPkdQkr.png)</span>. 
...
{: .box-warning}
## Exercice 3 Paramètres de sécurité d'un navigateur
...
En 2018, une nouvelle directive européenne est entrée en vigueur : le RGPD - Règlement Général sur la Protection des Données. 
	Elle encadre le traitement des données personnelles sur le territoire de l'Union européenne.
1. Chercher sur le site de la CNIL les définition des termes suivants :
	- une donnée personnelle
	- anonymisation de données personnelles 
1. **Le respect des données personnelles** s'appuie sur les concepts énumérés ci-dessous. À l'aide du site de la CNIL résumer les brièvement.
	- Pertinence 
	- Transparence 
	- Consentement et  Principe de la finalité du traitement de données 
	- Gardez la maîtrise des données 
	- Gestion des risques 
	- Privacy by design
1. À quelle amende s'expose-t-on si on ne respecte pas le dernier point ?  
1. Visiter la page  [cnil et traceurs](https://www.cnil.fr/fr/cookies-traceurs-que-dit-la-loi) et répondre aux questions suivantes :
...
## Bilan
<div>
{%- include extensions/youtube.html id='OFRjZtYs3wY' -%}
</div> 