...
est une fonction polynôme de degré 2
	si il existe $a\neq0$, $b$ et $c\in\mathbb{R}$ tel que :\sidenote{nous dirons fonction quadratique}  
	\setlength{\abovedisplayskip}{3pt}
	\setlength{\belowdisplayskip}{3pt}
	$$\text{pour tout} \;x\in\mathbb{R} \qquad f(x)=ax^2+bx+c$$   
Sa représentation graphique s'appelle une \textbf{parabole} (\href{https://www.desmos.com/calculator/3tknwzoelj}{Desmos V1} et \href{https://www.desmos.com/calculator/8t1vcgdrmr}{V2}). 
\end{definition} 
\begin{figure*}[!hb] 
...
\begin{figure}[!h] 
	...
	\begin{tikzpicture}
		...
		\tkzTabVar{-/$-\infty$  ,+ /$\upbeta$,  -/ $-\infty$}  
	\end{tikzpicture} 
	\caption{Représentation graphique d'une fonction quadratique donné par forme canonique $f(x)=a(x-\upalpha)^2+\upbeta$.\href{https://www.desmos.com/calculator/ndteejmkxy}{Desmos V1} et \href{https://www.desmos.com/calculator/zypbljxm9p}{V2}
}
\end{figure}
...
$\begin{WithArrows}
	f(x)&=-x^2+10x -25 \\
	& = -\left[ x^2 \ldots 10x \ldots 25\right] %S \\
%	& =  \\
%	& = \\
%	& = \\
%	& = \\
...
\onehalfspacing
\subsection*{Exercices : la forme factorisée}
...
\end{exercise}
\newpage 
\begin{exercise}\label{chapitre01:exercice:factorise:03}\hfill \\
 Suivre la démarche proposée pour trouver la forme factorisée $f(x)=a(x-r_1)(x-r_2)$ des fonctions quadratiques représentées ci-dessous.
	\begin{enumerate}[label=\alph*), leftmargin=*]
...
\onehalfspacing
\section{La forme factorisée : produit et somme des racines}
...
\onehalfspacing
\subsection{Exercices : la forme factorisée et somme et produit des racines}
...
\end{eBox}
\begin{exercise} \emoji{cactus}Soit la fonction cubique $P(x)=-x^3+8x^2+11-18$. 
	\begin{enumerate}[label=\alph*), leftmargin=*]
...
\end{enumerate} 
\end{exercise}
\begin{exercise}[entraînement] \emoji{cactus} Soit la fonction cubique $P(x)=-2x^3+10x^2-16+8$. 
	\begin{enumerate}[label=\alph*), leftmargin=*]
...
\begin{exercise}[Grand classique] Soit $f$ la fonction définie sur $\mathbb{R}$ par $f(x)=2x^2+4x-16$.
	\begin{enumerate}[leftmargin=*,label=\arabic*)]
		\item Montrer que pour tout $x\in\mathbb{R}$ on a $f(x)=2(x+4)(x-2)$
...
\end{exercise}
\begin{exercise} 
	 Soit $f$ la fonction définie sur $\mathbb{R}$ par $f(x) =3x^2+14x+15$ et $\mathscr{P}$ sa représentation graphique.
	\begin{enumerate}[leftmargin=*,label=\arabic*)]
...
\end{exercise} 
\begin{exercise} 
	Soit $f$ la fonction définie sur $\mathbb{R}$ par $f(x) =4x^2+8x+3$ et $\mathscr{P}$ sa représentation graphique.
	\begin{enumerate}[leftmargin=*,label=\arabic*)]
		...
		\begin{multicols}{2}
			\begin{enumerate}[leftmargin=*,label=\alph*)]
				...
				\item Résoudre l'inéquation $f(x)<3$, inconnue $x$.
...
\end{exercise} 
\begin{exercise} 
	 Soit $f$ la fonction définie sur $\mathbb{R}$ par $f(x) =(x+5)^2-(3x-4)(x+5)$.
	\begin{enumerate}[leftmargin=*,label=\arabic*)] 
