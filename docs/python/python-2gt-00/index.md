...
!!! info "Consignes"
	...
	Pour cette fois, _vous_ endosserez le rôle d'interpréteur de code Python. Vous lirez et exécuterez le programme proposé pour trouver la bonne trajectoire et remporté les défis.
