...
def produit() :
	accumulateur = 1                       # initialisation de l'accumulateur
	for loop in range(1,51) :                 # i prend les valeurs 1 à 50 
		accumulateur = accumulateur * i    # multiplier l'accumulateur par i 
	return accumulateur  	
