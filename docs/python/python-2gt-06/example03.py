...
def tests():  
    ...
    exp_AB = 5
    exp_BC = 12 
    msg_AC = f"la longueur de AC devrait être {exp_AC} et non {val_AC}" # La totale
    msg_AB = f"la longueur de AC devrait être {exp_AB} et non {val_AB}" # La totale
    msg_BC = f"la longueur de AC devrait être {exp_BC} et non {val_BC}" # La totale
