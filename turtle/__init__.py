...
def _default_cfg():
    return {
        ...
        # "undobuffersize": 1000,
        "shape": "turtle",
        "pencolor": "var(--md-admonition-fg-color)", #"black",
        "fillcolor": "var(--md-admonition-fg-color)", #"black",
        # "resizemode" : "noresize",
        "visible": True,
...
def create_circle(r):
    ...
    circle = SVG.circle(x=0, y=0, r=r, stroke=_CFG["pencolor"], fill=_CFG["fillcolor"]) #"black", fill="black")
...
def create_polygon(points):
    ...
    polygon = SVG.polygon(points=points, stroke=_CFG["pencolor"], fill=_CFG["fillcolor"]) #"black", fill="black")
...
def create_rectangle(width=2, height=2, rx=None, ry=None):
    ...
    rectangle = SVG.rect(
        ...
        width=width,
        height=height,
        stroke=_CFG["pencolor"], #"black",
        fill=_CFG["fillcolor"], #"black",
    )
...
class TPen:
    ...
    def _reset(self, pencolor=_CFG["pencolor"], fillcolor=_CFG["fillcolor"]):
        ...
        self._shown = True
        self._drawing = True
        self._pencolor = pencolor #"black"
        self._fillcolor = fillcolor #"black"
        self._speed = 3
    ...
    def _make_copy(self, name=None):
        ...
        if self.screen._animate:
            ...
            _turtle.setAttribute(
                "transform",
                f"translate({x}, {y}) " f"rotate({self._old_heading}, 0, 0)",
            )
